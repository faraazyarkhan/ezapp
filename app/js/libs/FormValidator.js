/**
* @fileOverview Contains code related to the CGI FormValidator class
...
if (!ErrorValidator) {
    /**
    * @namespace Global namespace for CGI related classes (such as FormValidator) and other relevant properties
    */
    var ErrorValidator = {};
}
...
* @type {FormValidator[]}
*/
ErrorValidator.validators = [];

(function ($) {
    /* Do not modify these: */
    /**
    * @property {number} allows creation of unique IDs if multiple CGIFormValidator instances are created on a page
    */
    var idCounter = 0;
    ...
    */
    function FormValidator(formGroupElement, triggerElement, customRulesObject) {
        ...
        */
        ...
        /** Set of validator rules. Default rules must be defined in CGIFormValidatorConfig.js that loads before this class, on ErrorValidator.defaultValidatorRules
        ...
        * NOTE: CGI teams should add, remove or modify these default rules where applicable
        * @type Object 
        */
        var _validatorRules = ErrorValidator.defaultValidatorRules ? ErrorValidator.defaultValidatorRules : {};

        /** Object containing Localized strings, where each key is a locale code, and each value is a nested object containing the 
        * individual string IDs and their localized translation. These values need to be defined in CGIFormValidatorConfig.js as ErrorValidator.validatorStrings
        ...
        * Note: CGI can add more locales as needed. As the FormValidator class evolves, additional strings may be added to each locale.
        * @type object
        */
        var _strings = ErrorValidator.validatorLocalizedStrings ? ErrorValidator.validatorLocalizedStrings : {};

        /**
        * How long to wait for asynchronous validation callbacks before they timeout. Must be modified in CGIFormValidatorConfig.js as ErrorValidator.validatorAsyncTimeoutDuration
        * @type number
        */
        var _asyncTimeoutDuration = ErrorValidator.validatorAsyncTimeoutDuration !== undefined ? ErrorValidator.validatorAsyncTimeoutDuration : 3000;

        /**
        * HTML strings used to generate the elements of the form validation summary list and inline errors.
        * May only be overridden in CGIFormValidatorConfig.js if you know what you're doing, NOT here
        * @type Object
        */
        var _markupStrings = {
        ...
        if (ErrorValidator.validatorHTMLStrings) {
            $.each(_markupStrings, function (key, value) {
                if (ErrorValidator.validatorHTMLStrings[key]) {
                    _markupStrings[key] = ErrorValidator.validatorHTMLStrings[key]
                }
            });
        }
        ...
        */
        ...
        if (ErrorValidator.customLogicForElementToFollow && typeof ErrorValidator.customLogicForElementToFollow == "function") {
            _customLogicForElementToFollow = ErrorValidator.customLogicForElementToFollow;
        ...
        * @param {HTMLElement|jQuery} trigger
        ...
        * @param {HTMLElement|jQuery} container The container element to use from now on
        ...
        * @param ruleId {string} The identifier associated with the rule object to be modified
        * @param ruleData {Array} 
        ...
        * @param field {HTMLElement} field on which the error should be triggered
        ...
        * @param field {HTMLElement|jQuery} field from which the error should be removed
        */
        ...
        * @param field {HTMLElement|jQuery} The field to validate
        */
        ...
        * @param validatorObj {object} Validator object currently being tested
        * @param value {string} The value being matched
        * @param $field {jQuery} The field containing the value being matched
        ...
        * @param $field {Object} jQuery reference to field that needs to be validated
        ...
        * @param rawStr {string} String which may or may not contain one or more %s occurrance
        * @param params {array} Replacement values that match the %s occurrances in rawStr 
        * @returns {string}
        */
        ...
        * @param strId {String} ID that matches key in _strings[FormValidator.currentLocale]
        * @param params Replacements for %s occurrances in the original string
        * @returns {string}
        */
        ...
        * @param errors {object} all the errors found
        * @param totalErrors {number} number of errors found
        */
        ...
        */
        function _init(formGroup, trigger, customRules) {
            ...
            _$formGroupContainer.on("blur", "[data-validate]:not(fieldset):not([data-no_inline_on_blur])", function (e, i) {
                var $field = $(this);
                if (!$field.is("[data-customerror]")) {
                    _validate($field, false);
                }
            ...
            _$fieldsToValidate.each(function () {
                var $field = $(this);
        ...
        ErrorValidator.validators.push(this);
    }
    ...
    * @static
    * @default "en_us"
    * @memberof ErrorValidator.FormValidator
    */
    ...
    */
    ...
    /**
    * Make class publically reachable. Create a new instance like this: var myValidator = new ErrorValidator.FormValidator(container);
    * NOTE: This global variable can be changed if necessary, it won't break the class
    * 
    */
    ErrorValidator.FormValidator = FormValidator;
})(jQuery);